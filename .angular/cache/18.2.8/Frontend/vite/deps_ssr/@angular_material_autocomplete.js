...
var MatAutocomplete = class _MatAutocomplete {
  ...
  constructor(_changeDetectorRef, _elementRef, _defaults, platform) {
    ...
    this._activeOptionChanges = import_rxjs3.Subscription.EMPTY;
...
var MatAutocompleteTrigger = class _MatAutocompleteTrigger {
  constructor(_element, _overlay, _viewContainerRef, _zone, _changeDetectorRef, scrollStrategy, _dir, _formField, _document, _viewportRuler, _defaults) {
    ...
    this._viewportSubscription = import_rxjs3.Subscription.EMPTY;
    this._breakpointObserver = inject(BreakpointObserver);
    this._handsetLandscapeSubscription = import_rxjs3.Subscription.EMPTY;
    this._canOpenOnNextFocus = true;
    this._closeKeyEventStream = new import_rxjs3.Subject();
    ...
    this.optionSelections = (0, import_rxjs3.defer)(() => {
  ...
  get panelClosingActions() {
    return (0, import_rxjs3.merge)(this.optionSelections, this.autocomplete._keyManager.tabOut.pipe((0, import_operators3.filter)(() => this._overlayAttached)), this._closeKeyEventStream, this._getOutsideClickStream(), this._overlayRef ? this._overlayRef.detachments().pipe((0, import_operators3.filter)(() => this._overlayAttached)) : (0, import_rxjs3.of)()).pipe(
  ...
  _getOutsideClickStream() {
    return (0, import_rxjs3.merge)((0, import_rxjs3.fromEvent)(this._document, "click"), (0, import_rxjs3.fromEvent)(this._document, "auxclick"), (0, import_rxjs3.fromEvent)(this._document, "touchend")).pipe((0, import_operators3.filter)((event) => {
  ...
  _subscribeToClosingActions() {
    const initialRender = new import_rxjs3.Observable((subscriber) => {
      afterNextRender(() => {
        subscriber.next();
      }, {
        injector: this._injector
    ...
    return (0, import_rxjs3.merge)(initialRender, optionChanges).pipe(
